...
if (exports.activated) cds.on ('served', () => {
  ...
  ds.on ('deploy', async function (req) {
    ...
    const schemaEvoOptions = cds.requires.extensibility ? { schema_evolution: 'auto' } : {}
    return await cds.deploy(csn, schemaEvoOptions, options?.csvs).to('db')
  })
  ...
  ds.on ('unsubscribe', async function (req) {
    ...
    LOG.info('successfully unsubscribed tenant', t)
  })
